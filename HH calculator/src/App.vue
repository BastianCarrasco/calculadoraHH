  ...
  <div class="use-case-estimator" ref="estimatorContent">
    ...
    <div class="section">
        ...
        <table>
          ...
          <tbody>
            <tr v-for="(actor, index) in actors" :key="'actor-' + index">
              ...
              <td>{{ actor.factor }}</td>
              <td>
                <input type="number" v-model.number="actor.count" min="0" />
              </td>
          ...
          <tfoot>
            <tr>
              <td colspan="4" class="text-right">
                <strong>Total Actor Weight (UAW):</strong>
              </td>
              <td>
                <strong>{{ totalUAW }}</strong>
              </td>
            </tr>
          </tfoot>
        </table>
        ...
        <table>
          ...
          <tbody>
            <tr v-for="(useCase, index) in useCases" :key="'usecase-' + index">
              ...
              <td>
                <input type="number" v-model.number="useCase.count" min="0" />
              </td>
          ...
          <tfoot>
            <tr>
              <td colspan="4" class="text-right">
                <strong>Total Use Case Weight (UUCW):</strong>
              </td>
              <td>
                <strong>{{ totalUUCW }}</strong>
              </td>
            </tr>
          </tfoot>
        </table>
      ...
      <div class="result">
        <h3>UUCP = UAW + UUCW</h3>
        <p>
          <strong>{{ totalUAW }} + {{ totalUUCW }} = {{ UUCP }}</strong>
        </p>
      </div>
    </div>
    ...
    <div class="section">
      ...
      <div class="subsection">
        ...
        <table>
          ...
          <tbody>
            <tr
              v-for="(factor, index) in technicalFactors"
              :key="'tech-' + index"
            >
              <td>{{ factor.code }}</td>
          ...
          <tfoot>
            ...
            <tr>
              <td colspan="4" class="text-right">
                <strong>TCF = 0.6 + (0.01 × TFactor):</strong>
              </td>
              <td>
      ...
      <div class="subsection">
        ...
        <table>
          ...
          <tbody>
            <tr
              v-for="(factor, index) in environmentalFactors"
              :key="'env-' + index"
            >
              <td>{{ factor.code }}</td>
              <td>{{ factor.description }}</td>
          ...
          <tfoot>
            <tr>
              ...
              <td>
                <strong>{{ EFactor }}</strong>
              </td>
            </tr>
            <tr>
              <td colspan="4" class="text-right">
                <strong>EF = 1.4 + (-0.03 × EFactor):</strong>
              </td>
              <td>
      ...
      <div class="result">
        ...
        <p>
          <strong
            >{{ UUCP }} × {{ TCF.toFixed(3) }} × {{ EF.toFixed(3) }} =
            {{ UCP.toFixed(3) }}</strong
          >
        </p>
      </div>
    </div>
    ...
    <div class="section">
      ...
      <div class="result">
        <h3>Horas-Hombre para Programación (40%)</h3>
        <p>
          <strong>{{ programmingHours.toFixed(2) }} horas</strong>
        </p>
        ...
        <table>
          ...
          <tbody>
            ...
            >
              ...
              <td>{{ activityHours(activity.percentage).toFixed(2) }}</td>
            </tr>
          </tbody>
          <tfoot>
            <tr>
              ...
              <td>
                <strong>{{ totalProjectHours.toFixed(2) }} horas</strong>
              </td>
            </tr>
          </tfoot>
        </table>
        ...
        <p>
          <strong>Para 1 persona:</strong>
          {{ weeksForOnePerson.toFixed(2) }} semanas ({{
            totalProjectHours.toFixed(2)
          }}
          horas)<br />
          <strong>Para {{ teamSize }} personas:</strong>
          {{ weeksForTeam.toFixed(2) }} semanas ({{
            (weeksForTeam * hoursPerWeek * teamSize).toFixed(2)
          }}
          horas)
        </p>
      </div>
  ...
  data() {
    return {
      ...
      actors: [
        {
          type: "Simple",
          description: "Otro sistema con una API definida",
          factor: 1,
          count: 0,
        },
        {
          type: "Medio",
          description:
            "Otro sistema interactuando con protocolo o persona en modo texto",
          factor: 2,
          count: 0,
        },
        {
          type: "Complejo",
          description: "Persona interactuando con interfaz gráfica",
          factor: 3,
          count: 0,
        },
      ],
      useCases: [
        {
          type: "Simple",
          description: "3 transacciones o menos",
          factor: 5,
          count: 0,
        },
        {
          type: "Medio",
          description: "4 a 7 transacciones",
          factor: 10,
          count: 0,
        },
        {
          type: "Complejo",
          description: "Más de 7 transacciones",
          factor: 15,
          count: 0,
        },
      ],
      ...
      technicalFactors: [
        ...
        {
          code: "T2",
          description: "Objetivos de performance o tiempo de respuesta",
          weight: 1,
          level: 0,
        },
        {
          code: "T3",
          description: "Eficiencia del usuario final",
          weight: 1,
          level: 0,
        },
        {
          code: "T4",
          description: "Procesamiento interno complejo",
          weight: 1,
          level: 0,
        },
        {
        ...
        {
          code: "T6",
          description: "Facilidad de instalación",
          weight: 0.5,
          level: 0,
        },
        ...
        {
          code: "T11",
          description: "Objetivos especiales de seguridad",
          weight: 1,
          level: 0,
        },
        {
          code: "T12",
          description: "Acceso directo a terceras partes",
          weight: 1,
          level: 0,
        },
        {
          code: "T13",
          description: "Facilidades especiales de entrenamiento a usuarios",
          weight: 1,
          level: 0,
        },
      ],
      ...
      environmentalFactors: [
        {
          code: "E1",
          description: "Familiaridad con el modelo del proyecto utilizado",
          weight: 1.5,
          level: 0,
        },
        {
          code: "E2",
          description: "Experiencia en la aplicación",
          weight: 0.5,
          level: 0,
        },
        {
          code: "E3",
          description: "Experiencia en orientación a objetos",
          weight: 1,
          level: 0,
        },
        {
          code: "E4",
          description: "Capacidad del analista líder",
          weight: 0.5,
          level: 0,
        },
        ...
        {
          code: "E6",
          description: "Estabilidad en los requerimientos",
          weight: 2,
          level: 0,
        },
        {
          code: "E7",
          description: "Personal de medio tiempo",
          weight: -1,
          level: 0,
        },
        {
          code: "E8",
          description: "Dificultad en el lenguaje de programación",
          weight: -1,
          level: 0,
        },
      ],
      ...
      activities: [
        ...
        { name: "Sobrecarga (otras actividades)", percentage: 15 },
      ],
    };
  },
  computed: {
    ...
    totalProjectHours() {
      // La programación es el 40%, entonces el total es programmingHours / 0.4
      return this.programmingHours / 0.4;
    },
    activityHours() {
      return function (percentage) {
        return (this.totalProjectHours * percentage) / 100;
      };
    },
    // Cálculos para UUCP
    totalUAW() {
      return this.actors.reduce(
        (sum, actor) => sum + actor.factor * actor.count,
        0
      );
    },
    totalUUCW() {
      return this.useCases.reduce(
        (sum, useCase) => sum + useCase.factor * useCase.count,
        0
      );
    },
    UUCP() {
    ...
    // Cálculos para TCF
    TFactor() {
      return this.technicalFactors.reduce(
        (sum, factor) => sum + factor.weight * factor.level,
        0
      );
    },
    TCF() {
    ...
    // Cálculos para EF
    EFactor() {
      return this.environmentalFactors.reduce(
        (sum, factor) => sum + factor.weight * factor.level,
        0
      );
    },
    ...
    weeksForOnePerson() {
      return this.totalProjectHours / this.hoursPerWeek;
    },
    weeksForTeam() {
    ...
    // Cálculo de costos
totalCost() {
  return this.totalProjectHours * this.hourlyRate;
},
  },
  methods: {
    generatePDF() {
